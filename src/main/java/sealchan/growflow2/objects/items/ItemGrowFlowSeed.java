...
public abstract class ItemGrowFlowSeed extends ItemFood implements IHasModel, IPlantable
{
	public ItemGrowFlowSeed(String name, int amount, boolean isWolfFood)
	{
	...
	protected abstract IBlockState getPlant();
