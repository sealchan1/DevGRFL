...
public class VANI_AzureBluet extends BlockGrowFlow
{
	public VANI_AzureBluet(String name) { super(name); }
	
	private int redFlowerType = BlockFlower.EnumFlowerType.HOUSTONIA.getMeta();
	
	@Override
	protected Item getSeed() { return ItemInit.SEED_AZUREBLUET; }
